...
const Footer = () => {
  return (
    ...
    <div id='contactUs'>
        <svg id="svgBottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill='#F4DECB' fillOpacity="1" d="M0,128L720,192L1440,128L1440,320L720,320L0,320Z"></path></svg>
            <div className="container-fluid pb-5 footerDiv">
              ...
              <div className="row">
                ...
                <div className="col-sm-4 text-center align-self-center">
                  <a className="p-1 nav-link" href="https://www.instagram.com/rakhi_reshamdhaaga/">Visit here for Privacy Policy, TnC &amp; Cancellation/Refund Policies </a>
                </div>
